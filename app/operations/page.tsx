    ...
    return (
        <section className="bg-white py-24 section-divide">
            <div className="mx-auto max-w-5xl px-6 text-center">
                ...
                <StaggerContainer className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4">
                    {standards.map((s, i) => (
                        <StaggerItem key={i}>
                            <div className="flex flex-col items-center gap-3 p-6 rounded-xl bg-neutral-50 ring-1 ring-neutral-100 hover:shadow-sm hover:ring-[#1b7fb9]/20 transition-all cursor-default">
